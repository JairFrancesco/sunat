...
<html>
    ...
    <body >
        <div id="app">
            ...
            <b-navbar type="dark" style="background-color: #563d7c;  padding-top: 15px; padding-bottom: 15px;" toggleable>
                <b-nav-toggle target="nav_dropdown_collapse" toggleable="md"></b-nav-toggle>
                <b-collapse is-nav id="nav_dropdown_collapse">
                    <b-container>
                        <b-nav is-nav-bar>
                            <b-navbar-brand href="#">Surmotriz S.R.L</b-navbar-brand>
