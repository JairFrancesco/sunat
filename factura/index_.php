			    ...
			    <v-data-table v-bind:headers="headers" :items="items" hide-actions class="elevation-1">
				    <template slot="items" scope="props">
						<td class="text-xs-center">{{ props.item.id }}</td>			      
				      	<td class="text-xs-center"><code>{{ props.item.docu }}</code></td>			      
	  	...
	  	data () {
	      	return {
	        	...
	        	headers: [
					...
					items: [
						{ id: '01', docu: 'F001-17153', cliente: 'Caceres Mamani Angela ceceda', eliminado: 'Si', sunat: '0001', total: '3,338.72 S/.', acciones: 'PDF XML COMP'},					
