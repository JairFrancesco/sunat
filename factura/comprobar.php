...
<soapenv:Envelope xmlns:ser="http://service.sunat.gob.pe" xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:wsse="http://docs.oasis-open.org/wss/2004/01/oasis-200401-wss-wssecurity-secext-1.0.xsd">
 ...
 <numeroComprobante>17335</numeroComprobante>
 </ser:getStatus>
 </soapenv:Body>
</soapenv:Envelope>
...
';
    ...
    if($matches_codigo[1][0]=='0004' || $matches_codigo[1][0] == '0001'){
        ...
        echo '<div style="text-align: center;"><strong>'.$serie.'-'.$cab_doc_gen['CDG_NUM_DOC'].'</strong> Existe y esta aceptada.'.$matches_codigo[1][0].'-'.$matches_mensaje[1][0];
